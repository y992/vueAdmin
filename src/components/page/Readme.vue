    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-upload"></i> 首页</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="allActive">
            <el-row class="head">
                <el-col :span="18" style="padding:20px 0;background: #33CCCC;">
                    <el-col :span="8">
                        {{ Business_totalActiveNum }}<br>
                        <span>商家总数</span>
                    </el-col>
                    <el-col :span="8">
                        {{ Member_totalActiveNum }}<br>
                        <span>中介总数</span>
                    </el-col>
...
<script>
    export default {
        ...
        data: function(){
            return {
                Business_totalActiveNum:40,
                Member_totalActiveNum:13,
                auditNum: 15,
            }
        }
    }
